...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String UPLOAD_URL = "https://ystc1247.pythonanywhere.com/api_root/Post/";
    // Local Android emulator test URL:
    ...
    private String uploadImage(String imageUrl) throws IOException, JSONException {
        ...
        try {
            ...
            // Part01 sends JSON only. Django applies the default Post image.
            ...
            return "Upload failed: HTTP " + responseCode;
